...
var swiper = function swiper() {
  ...
  (function (global, factory) {
    (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && "object" !== 'undefined' ? module.exports = factory() : typeof define === 'function' && __webpack_require__.amdO ? define(factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Swiper = factory());
  })(_this, function () {
    'use strict';
    /**
     * SSR Window 4.0.2
...
/* harmony export */   "workersSlider": function() { return /* binding */ workersSlider; }
/* harmony export */ });
var sliderBlock = document.querySelector('.workers-slider');

var workersSlider = function workersSlider() {
  var swiper;
...
var mask = function mask() {
  ...
  var maskCard = IMask(modalPhone, maskOptionsPhone);
};
...
var mainMenu = function mainMenu() {
  var headerButtonMobile = document.querySelector('.header__button-mobile');
  var openMenuButton = document.querySelector('.header__toggle--open');
  var closeMenuButton = document.querySelector('.header__toggle--close');
  ...
  var headerLogoMobile = document.querySelector('.header__logo');
  var headerTitleMobile = document.querySelector('.header__title-mobile');
  var headerContacts = document.querySelector('.header__contacts');
  var navigationItemApple = document.querySelector('.navigation__item--apple');
  var navigationLinkApple = document.querySelector('.navigation__item--apple .navigation__link');
  var navigationSubLinkIphone = document.querySelector('.navigation__item--apple .navigation__sublink--iphone');
  var navigationSubLinkIpad = document.querySelector('.navigation__item--apple .navigation__sublink--ipad');
  var navigationSubLinkMacbook = document.querySelector('.navigation__item--apple .navigation__sublink--macbook');
  var navigationItemCatalog = document.querySelector('.navigation__item--catalog');
  var navigationItems = document.querySelectorAll('.navigation__item');
  var navigationItemsMobile = document.querySelectorAll('.navigation__item--add');
  var headerArrowButton = document.querySelector('.header__arrow-button');
  var body = document.getElementsByTagName('body');
  ...
  var createCard = function createCard(item) {
    ...
    newCard.classList.add("".concat(item.class));
    newCard.innerHTML = "\n    <a class=\"navigation__link\" href=\"#\" target=\"_blank\">".concat(item.product, "</a>");
    navigationMenu.append(newCard);
  };

  var fillCardsList = function fillCardsList(data) {
  ...
  navigationItemApple.addEventListener('click', function (evt) {
    evt.preventDefault();
    navigationItems.forEach(function (item) {
      item.classList.add('is-hidden');
    });
  ...
  navigationMenu.addEventListener('click', function (evt) {
    var target = evt.target.closest('.navigation__item--iphone');
    var targetIpad = evt.target.closest('.navigation__item--ipad');
    var targetIphone = evt.target.closest('.navigation__item--macbook');
    headerArrowButton.style.display = 'block';
    var navigationItemsNew = document.querySelectorAll('.navigation__item--new');

    if (target) {
      evt.preventDefault();
      navigationItemsNew.forEach(function (item) {
    ...
    closeMenuButton.addEventListener('click', function () {
      var navigationItemsNewNew = document.querySelectorAll('.navigation__item--new');
      navigationItemsNewNew.forEach(function (item) {
        item.remove();
      });
...
/* harmony import */ var _js_swiper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var _workers_slider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4);
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5);
/* harmony import */ var _imask__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6);
/* harmony import */ var _menu__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_menu__WEBPACK_IMPORTED_MODULE_5__.mainMenu)();
  (0,_workers_slider__WEBPACK_IMPORTED_MODULE_2__.workersSlider)();
  (0,_imask__WEBPACK_IMPORTED_MODULE_4__.mask)();
});
}();
/******/ })()
;